...
function testMinimumValue1(){
    let result = MinimumValue([25,1,34,4567,2,8,56,234,-2,-34,-70,45,7,-1])
    let expected = -70
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testMinimumValue2(){
    let result = MinimumValue([5,6,8,2,8,2,9,3,3,67,8,23,56734,2,234])
    let expected = 2
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
testMinimumValue1()
...
function testMaximumValue1(){
    let result = MaximumValue([3,4,7,21,6,2,35,234,5,235,75,23,5345,3452,234,564])
    let expected = 5345
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testMaximumValue2(){
    let result = MaximumValue([-30,-23,-34,-340,-4,-3499])
    let expected = -4
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
testMaximumValue1()
...
function testCalculateRemainder1(){
    let result = CalculateRemainder(900, 200)
    let expected = 100
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testCalculateRemainder2(){
    let result = CalculateRemainder(1200, 400)
    let expected = 0
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
...
function testDistinctValues1(){
    let result = DistinctValues([1,3,4,6,3,1,6,3,6,2,1,6,87,2,7,2,34,7,2,1])
    let out = 0
    let expected = [1,3,4,6,2,87,7,34].toString()
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testDistinctValues2(){
    let result = DistinctValues([1,1,1,1,4,6,5,9,5,4,78,5,89,5,34,9,5,324,5,7,4,45,78,4,345,7,56,23,34,34])
...
function testCountValues1(){
    let result = CountValues([1,1,1,2,2,2,2,4,4,5,7,9,9,9,0])
    let expected = '1(3)  2(4)  4(2)  5(1)  7(1)  9(3)  0(1)  '
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testCountValues2(){
    let result = CountValues([2,3,2,3,2,5,6,78,3,76,3,7,3,7,3,56,8,5,45,78,4,75,4,75,34,3,5,3,43,34])
...
function testEvaluateExpression1(){
    let result =  EvaluateExpression('a + b + c - d', obj = { a : 1, b : 7, c : 3, d : 14} )
    let expected = -3
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
function testEvaluateExpression2(){
    let result = EvaluateExpression('a - b + c + d + e - f - g', obj = { a : 5, b : 7, c : 10, d : 18, e : 15, f : 9, g : 3})
    let expected = 29
    console.assert(result === expected, `esperado: ${expected}, obtido: ${result}`)
}
